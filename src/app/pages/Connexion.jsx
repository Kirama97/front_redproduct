      ...
      <div className="w-xl">
        ...
        <div className="w-full bg-white px-7 py-10 rounded-sm">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-2 py-2">
            <input
              className={`w-full outline-none text-xs py-2 border-b ${
            ...
            <input
              className="w-full outline-none text-xs py-2 border-b border-neutral-300"
              type="password"
            ...
            {loading ? (
              <button
                disabled
                className="bg-neutral-500 py-2 rounded-lg mt-5 flex items-center justify-center gap-2 text-white text-xs"
              >
              ...
              <button
                type="submit"
                className="bg-neutral-800 py-2 rounded-lg mt-5 text-white text-xs hover:bg-neutral-900"
              >
                Se connecter
              </button>
            )}
        ...
        <div className="w-full text-white text-center py-2">
          <a className="text-[10px] text-yellow-300">
            Mot de passe oublié ?
          </a>
